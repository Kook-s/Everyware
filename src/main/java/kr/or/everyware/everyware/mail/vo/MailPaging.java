...
public class MailPaging<T> {
	...
	public void setTrashTotal(int trashTotal) {
	...
	public void setMailUnreadCount(int mailUnreadCount) {
	...
	public String toString() {
		return "MailPaging [totalRecord=" + totalRecord + ", totalPage=" + totalPage + ", currentPage=" + currentPage
				...
				+ ", searchType=" + searchType + ", searchWord=" + searchWord + ", menuName=" + menuName + ", empId="
				+ empId + "]";
	}
