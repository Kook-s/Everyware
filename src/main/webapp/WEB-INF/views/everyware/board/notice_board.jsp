				...
				<div class="card card-primary card-tabs">
					<div class="card-header p-0 pt-1">
						<ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
							<li class="nav-item">
							<a class="nav-link ${notice_board }"
								id="custom-tabs-five-overlay-tab"
								 data-toggle="pill"
								aria-selected="true">공지사항
							</a></li>
								
							<li class="nav-item">
							<a class="nav-link ${free_board }"
							data-toggle="pill"
								id="custom-tabs-five-overlay-dark-tab" 
								aria-selected="false">자유게시판 
							</a></li>
								
							<li class="nav-item">
							<a class="nav-link ${file_board }"
							data-toggle="pill"
								id="custom-tabs-five-normal-tab"
								 aria-selected="false">양식함 
							</a></li>
												...
												<c:otherwise>
													<c:forEach items="${pagingVO.dataList}" var="board">
														<tr>
															...
															<td style="text-align: center;">${board.pstId}</td>
															<td><a
						...
						$.ajax({
									...
									success : function(response) {
										...
										if (response == "OK") {
											...
											location.href = "/everyware/boardList?category=1";
										} else {
											Toast.fire({
												icon : 'error',
												title : '삭제가 실패되었습니다...'
